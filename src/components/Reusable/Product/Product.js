...
const Product = ({ productData, notify }) => {
        ...
        <>
            <div className="productComp">
                ...
                <div className="productImagesAndOptions">
                    <a className="d-flex align-items-center" href={"/product/" + productData.for + "/" + productData.categories + "/" + productData?.id}>
                ...
                <div className="productOptions d-flex">
                    ...
                    <span type="button" class="btn btn-primary productDetailsDropdownBtn" data-bs-toggle="modal" data-bs-target={"#productDetailModal" + productData?.id} className="productFullScreen">
                ...
                <div className="productContent mt-3">
                    ...
                    <div className="product-content-right d-flex">
                        <div className="h6 text-secondary">$ {productData?.price}</div>
